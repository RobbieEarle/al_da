...
app.controller('ResultsController', ['$scope', '$rootScope',
    ...
    function ResultsController($scope, $rootScope) {
        ...
        $scope.service_click = function() {
            console.log("Click");
            if ($scope.results_settings['file_services'])
...
app.controller('ServicePopulateController', ['$scope',

    function ServicePopulateController($scope) {
