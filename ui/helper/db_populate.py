...
# cursor.execute("""
# INSERT INTO setting(setting_name, user_id, user_pw, terminal, al_address, al_username, al_api_key,
#   smtp_server, smtp_port, smtp_username, smtp_password)
#   VALUES(?,?,?,?,?,?,?,?,?,?,?)
# """, ('SAVED', 'admin', 'changeme', 'DEV_TERMINAL', 'https://134.190.171.253/', 'admin', '1a2b3c4d5e6f', 'outlook.office365.com',
