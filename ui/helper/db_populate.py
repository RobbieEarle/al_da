"""
This file was used to populate my database with default values; is not used in the actual application
"""
...
results = [(1, cipher_suite.encrypt(b'mal_files'), cipher_suite.encrypt(b'1'), 1),
           (2, cipher_suite.encrypt(b'safe_files'), cipher_suite.encrypt(b'0'), 1),
