...
def start():
    ...
    installer.milestone('\r\n\r\nPassword has been successfully set. Please enter "sudo reboot" now and follow the '
                        'steps listed above when prompted: "Perform MDK Management" > "Enroll MDK" > Continue '
